...
const identityDocuments: IdentityDocument[] = [
  { documentType: "Colateral", documentNumber: "19900514-12345-00001-23", issueDate: "May 14, 2019", expiryDate: "-", status: "Verified" },
  { documentType: "Contract", documentNumber: "123-456-789", issueDate: "May 14, 2019", expiryDate: "-", status: "Verified" },
...
const LoanDocumentsTable = ({ onView, onDownload, onDelete }: IdentityDocumentsTableProps) => {
  return (
    <Card>
      <CardContent className="flex flex-col gap-4">
        <div className="flex items-start gap-2">
          ...
          <div className="flex flex-col">
            <h2 className="text-sm font-semibold">Loan Documents</h2>
            <p className="text-sm text-muted-foreground">Upload and manage applicant's application documents</p>
          </div>
        </div>
