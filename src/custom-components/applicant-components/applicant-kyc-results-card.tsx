    ...
    <div className="flex flex-col gap-4">
      <Card>
        <CardContent className="flex flex-col items-center gap-3 py-10 text-center">
          <KycSuccessBadge />
          <h2 className="text-lg font-semibold">KYC Verification Successful!</h2>
          <p className="max-w-md text-sm text-muted-foreground">
            The applicant's identity has been verified and all required checks have been completed successfully.
          </p>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-base font-semibold">KYC Summary</CardTitle>
          </CardHeader>
